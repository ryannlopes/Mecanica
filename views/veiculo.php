            ...
            <div class="col-md-12">
              <div class="card card-plain">
                <div class="card-header card-header-primary">
                  <h4 class="card-title mt-0"> Veículos</h4>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table table-hover">
                      <thead class="">
                        ...
                        <th></th>
                        <th>
                          <a type="button" href="../forms/formVeiculo.php" rel="tooltip" title="Adicionar" style="margin-left: 18px;">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td style="width: 5%">
                            <a href="../forms/editveiculo.php?idVeiculo=<?php echo $dados['idVeiculo']?>">
                          ...
                          <td style="width: 5%">
                            <a href="../delete/veiculo.php?idVeiculo=<?php echo $dados['idVeiculo']?>">
