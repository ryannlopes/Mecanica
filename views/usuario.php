                  ...
                  <div class="table-responsive">
                    <table class="table table-hover">
                      <thead class="">
                        ...
                        <th></th>
                        <th>
                          <a type="button" href="../forms/formUsuario.php" rel="tooltip" title="Adicionar" style="margin-left: 18px;">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td style="width: 5%">
                            <a href="../forms/editUsuario.php?idUser=<?php echo $dados['idUser']?>">
                          ...
                          <td style="width: 5%">
                            <a href="../delete/user.php?idUser=<?php echo $dados['idUser']?>">
