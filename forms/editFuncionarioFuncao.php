...
<body class="dark-edition">
  ...
  if (isset($_GET['id'])) {
    ...
    $query = "SELECT id, id_funcionario, id_funcao, nomeFuncionario, nomeFuncao 
                  FROM funcionariofuncao
                  INNER JOIN funcionario ON id_funcionario = idFuncionario
                  INNER JOIN funcao ON id_funcao = idFuncao WHERE id = '$id'";
    $busca = mysqli_query($conn, $query);
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" href="javscript:void(0)" id="navbarDropdownMenuLink" data-toggle="dropdown"
                  ...
                  <div class="d-flex align-items-center justify-content-center">
                    ...
                    <h1 style="font-size: 15px; margin: 0; text-transform: capitalize;">
                      <?php echo $nome; ?>
                    </h1>
                  </div>
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item" href="../login/logout.php" style="padding: 3px 3px;"><i
                      class="material-icons">close</i>Sair</a>
                </div>
              </li>
            </ul>
          </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Editar Relatório Funcionário Função</h4>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input class="form-control" type="text" id="id" name="id"
                            value="<?php echo htmlspecialchars($dados['id']) ?>">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select name="funcionario" class="form-control" style="color: currentColor">
                            <option value="<?php echo $dados['id_funcionario']; ?>" selected><?php echo $dados['nomeFuncionario']; ?></option>
                            <?php
                            require('../conexao.php');
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <select name="funcao" class="form-control" style="color: currentColor">
                            <option value="<?php echo $dados['id_funcao']; ?>" selected><?php echo $dados['nomeFuncao']; ?></option>
                            <?php
                            require('../conexao.php');
