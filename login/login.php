...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows == 1) {
        ...
        header("Location: ../views/dashboard.php"); // Redirecionar para a página de dashboard ou página protegida
    } else {
        // Login inválido
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
                    ...
                    <label class="bmd-label-floating">Não possui login? <a href="register.php">Cadastre-se agora!</a></label>
